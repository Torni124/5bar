...
class Dynamics:
    ...
    def forward_kinematics(self, q1, q2):
        """
        Calculates forward kinematics for the 5-bar linkage.
        
        :param q1: Angle of the first link
        :param q2: Angle of the second link
        :return: (x, y) coordinates of the end-effector
        """
        q3, q4 = self.get_q3_q4(q1, q2)
        
        x = self.a1 * math.cos(q1) + self.a3 * math.cos(q1 + q3)
        y = self.a1 * math.sin(q1) + self.a3 * math.sin(q1 + q3)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        q1 = math.degrees(solution[0])
        q2 = math.degrees(solution[1])
        move_l = last_l - q1
        move_r = last_r - q2
        ld = True
        rd = True
        ...
        if(move_r < 0):
            rd = False
        #moveBoth(math.abs(move_l), ld, math.abs(move_r), rd)
